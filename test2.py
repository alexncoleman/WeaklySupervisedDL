from Single_stage_tools2 import *
import torch
...
if __name__ == "__main__":
    ...
    cls_head = SimpleClassificationHead(in_channels=backbone.out_channels, num_classes=2)
    #seg_head = SimpleSegmentationHead(in_channels=backbone.out_channels, num_seg_classes=37)

    seg_head = UNetSegmentationHead(in_channels=112, num_classes=3)
